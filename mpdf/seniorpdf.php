...
<body>
	<div style='border:0.5mm solid #000033; width:460px; padding:50px 30px 30px 30px;'>
	<table border='1px'>
	<tr><th align='center' colspan='3'><h2>Senior Citizen ID card.</h2></th></tr>
		<tr>
			...
			<td  align='center'><img  height='140px' width='100px' src='../img/india.png'/></td>
			<td  align='right'><div style=''><img border='10px' height='140px' width='140px' src='qrcode/image.php?msg=$msg &amp err=L' /></td>
		</tr>
		<tr>
