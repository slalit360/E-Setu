...
$qry = array("cert_no"=>$cert, "name"=>$name,"mob"=>$mob, "email"=>$email,"gender"=>$gender,"add"=>$add,"doc"=>$doc,"dob"=>$dob,"bplace"=>$bplace,"date"=>$today,);
...
{	
	...
	window.location ='http://localhost/setu/domprint.php';</script>";
  ...
  <?php
   ...
   <table class='menu1'>
    <tr>
     <td>
      <div>
       <fieldset class='abc' style="margin-left:290px;">
        <legend>Domacile Certificate </legend>
        <form name='myForm' action="" onsubmit='return validateForm()' method='post'>
         <table class='login' width='500pt'>
          ...
          <tr>
           ...
           <td>
            <input type="number" name="mob" size="10" value="<?php echo $smob; ?>" placeholder="9876543210" required>
           </td>
          </tr>
          <tr>
           <td>Email Id:</td>
		  ...
		  <tr>
			<td>Birth Date <sup>*</sup>:</td><td><input type="date" size="20" name="dob" value="" required placeholder="DD/MM/YYYY"/><br></td>
		  </tr>
		  <tr>
			<td>Birth place <sup>*</sup>:</td><td><input type="text" size="40" name="bplace" value="" required placeholder="Village/town/city, district,State"/><br></td>
		  </tr>
          <tr>
