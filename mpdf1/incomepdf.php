...
<div style='border:0.6mm solid #000033; padding:30px 30px 30px 30px;'>
	...
	<h4 align='center'><u>INCOME CERTIFICATE</u></h4>
	<h5 align='center'>( Issued By Authorities in State of Maharashtra )</h5>
	<h3 align='center'><u><b>CERTIFICATE</b></u></h3>
	<p style='font-size:12px;'> On Submission of the Proof noted below , it is hereby Certified that, Mr/Mrs/Shri <b> $name </b>, $hs having Currently Residence At <b>$add, Maharashtra </b>is having total family Income from all Sources is as:-</p>
		<table border='1' align='center'>
		<tr align='center'>
		  <th>Year</th><th>Total Income(Rs)</th>
		</tr>
		<tr align='center'>
		  <td>$d[2] - $dd.</td><td> $income Rs.</td>
		</tr>
		</table>
	<p style='font-size:12px;'>Currently this certificate Is Provided to Mr/Mrs/Shri <b> $name </b>, for the Purpose of $purpose for $hhs Son/Daughter/$self. </p>
	
	<h4 align='center'>Particulers of Proof Submitted </h4>
	<ul style='font-size:12px;'>Application Details : $d[0] $d[1] $d[2].</ul>
	<ul style='font-size:12px;'> $str1 . $str2 . $str3 . $str4 ..</ul>
